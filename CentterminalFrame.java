...
public class CentterminalFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonModifyDownTimeCode.setToolTipText("<html>Ez a nyomógomb az állásidőt módosítja. <br>nAz állásidő kezdő dátuma nem változik meg.<br>A korábban kiválasztott kódot átírja a most kiválasztottra.</html>");
        ...
        jPanel2.add(jButtonAboutBox, gridBagConstraints);
...
//**Egér esemény az állásidőkód fában*/
    ...
    private void jButtonAboutBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAboutBoxActionPerformed
        CentTerminal.debug.printDebugMsg(null, CentterminalFrame.class.getName(), "jButtonAboutBoxActionPerformed(evt) : TMK nyomógomb megnyomva");
        if(this.centTerminalAboutBox==null){
            this.centTerminalAboutBox = new CentTerminalAboutBox(this);
        }
